...
import net.uniquecomputer.flipnointernet.R;
import net.uniquecomputer.flipnointernet.viewmodel.CheckoutViewModel;
...
import net.uniquecomputer.flipnointernet.databinding.ActivityCheckoutBinding;
